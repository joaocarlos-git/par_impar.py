...
raiz = Tk()
#raiz.iconbitmap('@/home/joao/PycharmProjects/ParImparShinobi/shinobi_par_impar/ninja.ico')

class Janela:

    """contrutor da janela do nosso jogo"""
    def __init__(self, raiz):
        ...
        self.img0 = PhotoImage(file="imagens/maos0.png")
        self.img1 = PhotoImage(file="imagens/maos1.png")
        self.img2 = PhotoImage(file="imagens/maos2.png")
        self.img3 = PhotoImage(file="imagens/maos3.png")
        self.img4 = PhotoImage(file="imagens/maos4.png")
        self.img5 = PhotoImage(file="imagens/maos5.png")
        self.img6 = PhotoImage(file="imagens/maos6.png")
        self.img7 = PhotoImage(file="imagens/maos7.png")
        self.img8 = PhotoImage(file="imagens/maos8.png")
        self.img9 = PhotoImage(file="imagens/maos9.png")
        self.img10 = PhotoImage(file="imagens/maos10.png")
        ...
        self.lb2 = Label(self.fr2, text="       JOGADOR      "+str(self.placar1)+ "   X   " + str(self.placar2) + "    COMPUTADOR",
                         bg=cinza1, font=fonte1, fg=azul2, pady=20)
        self.lb2.pack()
        ...
        self.bt_jogar = Button(self.fr6, bg=cinza2, text="JOGAR", font=fonte1, relief=RAISED, border=8,
                               command=self.jogar)
        ...
        try:
            ...
            if escolha == "par" or escolha == "impar":
                if num >= 0 and num <= 10:
                   ...
                   self.lb_erro["text"] = "ESCOLHA PAR OU IMPAR OU DE 0 A 10"
...
#raiz.iconbitmap("imagens/ninja.ico")
